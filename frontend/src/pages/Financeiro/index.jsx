        ...
        <header className="bg-white rounded-xl shadow-md p-3 flex-shrink-0 border-b">
          <div className="w-full flex justify-between items-center flex-wrap gap-3">
            ...
            <div className=" flex gap-3 items-center">
              ...
              <div className="flex flex-end items-center gap-3 p-4 rounded-lg border bg-gray-50 border-gray-200 ">
          ...
          <div className="gap-4 flex items-center justify-center rounded-lg">
            
            {/* 3. PESQUISAR (CENTRALIZADO NO GRID - OCUPA 2 COLUNAS) */}
            <div className="md:col-span-2  flex flex-col">
              <div className="relative">
                <FaSearch className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
                <Input value={buscaNome} onChange={(e) => setBuscaNome(e.target.value)} placeholder="Pesquisar aluno..." className="pl-9 pr-11 h-9" />
                {buscaNome && (
